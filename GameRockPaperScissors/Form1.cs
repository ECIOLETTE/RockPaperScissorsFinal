    ...
    public partial class Form1 : Form
    {
        ...
        void OptionsPlayer()
        {
            switch (player1)
            {
                case Options.Rock:
                    ...
                    imgPlayer1.BackgroundImage = img1;
                    break;
                case Options.Paper:
                    Image img2 = Properties.Resources.paper;
                    imgPlayer1.BackgroundImage = img2;
                    break;
                case Options.Scissors:
                    Image img3 = Properties.Resources.scissors;
                    imgPlayer1.BackgroundImage = img3;
                    break;
            }
        }
        void OptionsComputer()
        {
            ...
            if (num == 1)
            {
                ...
                imgCPU.BackgroundImage = img;                    
            }
            if (num == 2)
            {
                computer = Options.Paper;
                Image img = Properties.Resources.paper;
                imgCPU.BackgroundImage = img;
            }
            if (num == 3)
            {
                computer = Options.Scissors;
                Image img = Properties.Resources.scissors;
                imgCPU.BackgroundImage = img;
            }
        ...
        private void BtnNewGame_Click(object sender, EventArgs e)
        {
            ...
            txtResultado.Text = ("");
            imgPlayer1.BackgroundImage = null;
            imgCPU.BackgroundImage = null;
        }
